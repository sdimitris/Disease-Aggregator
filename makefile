diseaseMonitor:
		...
		gcc -I  ./headfiles ./src/diseaseMonitor.c ./src/avl_tree.c ./src/hash_table.c ./src/functions.c ./src/record_list.c ./src/queries.c -D_XOPEN_SOURCE -o  ./build/diseaseMonitor
